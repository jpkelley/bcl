...
This is **not** about enforcing a single “correct” way to analyze your data (e.g. epistemic gate-keeping). It is about about ensuring that the ecological inference are logically associated with the specific questions that you asking.
...
-   **Franks _et al._ (2025).** Ecology needs a causal overhaul. *Biological Reviews*.\
    Ecology must adopt explicit causal inference frameworks beyond statistical associations.

-   **Sih _et al._ (2004).** Behavioral syndromes: an ecological and evolutionary overview. *Trends in Ecology & Evolution*.\
...
-   **Laland _et al._ (2016).** An introduction to niche construction theory. *Evolutionary Ecology*.\
